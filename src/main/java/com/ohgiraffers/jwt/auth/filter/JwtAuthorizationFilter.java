...
* 사용자 정보 인증 컨텍스트에 등록하여 해당 요청이 인증된 사용자로서 처리되도록 한다.
* */
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    /*
    * url 요청이 왔을 때 인가(권하ㅑㄴ)가 필요없는 url
    * 이 필터에 걸리지 않게 처리
    * */
    @Override
        ...
        * */
        ...
        try {
            ...
            if(header != null && !header.equalsIgnoreCase("")){
                ...
                // 검증 결과가 True(유요한 토큰)이면 이후 처리를 진행한다.
            ...
            // Exception 발생시 Exception 내용을 response에 담는다.
